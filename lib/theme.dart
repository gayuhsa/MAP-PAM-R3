...
class AppTheme {
  ...
  static const Color container = Color(0xFFD5F5D2);
  static const Color subcontainer = Color(0xFFD5F5D2);

  static const Color bottomBar = Color(0xFFD5F5D2);
  static const Color card = Color(0xFFE4FDE1);
  static const Color cardBorder = Color(0xFFC6EDC3);
